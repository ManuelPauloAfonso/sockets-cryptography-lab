...
class TodoList:
    ...
    # Defined a missing_todo function
    def missing_todo(self):
        # count how many items have been marked completed
        ...
        print(f"Missing todos: {missing_count}")
        return missing_count, completed_count 
...
while True:
    ...
    if choice == "1":
        ...
        missing_count, completed_count = todo_list.missing_todo()
        result = f" Incomplete todos: {missing_count},\n With {completed_count} completed."
